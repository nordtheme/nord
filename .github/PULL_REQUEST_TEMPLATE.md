...
> **Please read the [contribution guidelines](https://github.com/hellotham/rosely/blob/develop/CONTRIBUTING.md) before filling out this pull request template**.
...
* **Ensure the pull request has not already been reported by using the [GitHub Pull Request search](https://github.com/hellotham/rosely/pulls)** — if it has **and the pull request is still open**, add a comment to the existing pull request instead of opening this new one. If you find a closed pull request that seems to be similar to this one, include a link to it in the [metadata head](#metadata-head) section of this pull request.
...
* **Ensure to adhere to the [pull request contribution guidelines](https://github.com/hellotham/rosely/blob/feature/gh-12-github-open-source-community-standards/CONTRIBUTING.md#pull-requests)**, especially the one for tests and documentations.
